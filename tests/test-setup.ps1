...
$ambientNamesToClear = @(
    ...
    'CCX_PROXY_URL', 'CCX_PROXY_TRANSPORT', 'CCX_SHIM_URL',
    'CCX_SUBAGENT_GUARDS', 'CCX_MAX_CONCURRENT_SUBAGENTS',
    'CCX_MAX_SUBAGENTS_PER_SESSION', 'CCX_MAX_SUBAGENT_SPAWN_DEPTH',
    'CCX_MAX_RETRIES', 'CCX_API_TIMEOUT_MS', 'CCX_REAL_CLAUDE', 'CCX_SKIP_HEALTH_CHECK',
...
try {
    ...
    Assert-FileContainsLine $configFile 'CCX_PROXY_TRANSPORT=http'
    Assert-FileContainsLine $configFile 'CCX_SUBAGENT_GUARDS=1'
    Assert-FileContainsLine $configFile 'CCX_MAX_CONCURRENT_SUBAGENTS=3'
    Assert-FileContainsLine $configFile 'CCX_MAX_SUBAGENTS_PER_SESSION=12'
    Assert-FileContainsLine $configFile 'CCX_MAX_SUBAGENT_SPAWN_DEPTH=1'
    Assert-FileContainsLine $configFile 'CCX_MAX_RETRIES=3'
    Assert-FileContainsLine $configFile 'CCX_API_TIMEOUT_MS=300000'
    ...
    foreach ($name in @(
        ...
        'CCX_SUBAGENT_GUARDS', 'CCX_MAX_CONCURRENT_SUBAGENTS',
        'CCX_MAX_SUBAGENTS_PER_SESSION', 'CCX_MAX_SUBAGENT_SPAWN_DEPTH',
        'CCX_MAX_RETRIES', 'CCX_API_TIMEOUT_MS', 'CCX_REAL_CLAUDE',
    ...
    $preservedText = [IO.File]::ReadAllText($configFile)
    $preservedText = $preservedText.Replace('CCX_PROXY_URL=http://127.0.0.1:18765', 'CCX_PROXY_URL=http://127.0.0.1:18766')
    $preservedText = $preservedText.Replace('CCX_PROXY_TRANSPORT=http', 'CCX_PROXY_TRANSPORT=auto')
    $preservedText = $preservedText.Replace('CCX_MAX_CONCURRENT_SUBAGENTS=3', 'CCX_MAX_CONCURRENT_SUBAGENTS=2')
    $preservedText = $preservedText.Replace('CCX_MAX_SUBAGENTS_PER_SESSION=12', 'CCX_MAX_SUBAGENTS_PER_SESSION=10')
    $preservedText = $preservedText.Replace('CCX_MAX_RETRIES=3', 'CCX_MAX_RETRIES=2')
    $preservedText = $preservedText.Replace('CCX_API_TIMEOUT_MS=300000', 'CCX_API_TIMEOUT_MS=240000')
    $preservedText += "CCX_CONTEXT_WINDOW=200000`nCCX_SHIM_URL=http://127.0.0.1:18767`n"
    [IO.File]::WriteAllText($configFile, $preservedText, (New-Object Text.UTF8Encoding($false)))
    ...
    Assert-FileContainsLine $configFile 'CCX_PROXY_URL=http://127.0.0.1:18766'
    Assert-FileContainsLine $configFile 'CCX_PROXY_TRANSPORT=auto'
    Assert-FileContainsLine $configFile 'CCX_SHIM_URL=http://127.0.0.1:18767'
    Assert-FileContainsLine $configFile 'CCX_CONTEXT_WINDOW=200000'
    Assert-FileContainsLine $configFile 'CCX_MAX_CONCURRENT_SUBAGENTS=2'
    Assert-FileContainsLine $configFile 'CCX_MAX_SUBAGENTS_PER_SESSION=10'
    Assert-FileContainsLine $configFile 'CCX_MAX_SUBAGENT_SPAWN_DEPTH=1'
    Assert-FileContainsLine $configFile 'CCX_MAX_RETRIES=2'
    Assert-FileContainsLine $configFile 'CCX_API_TIMEOUT_MS=240000'
